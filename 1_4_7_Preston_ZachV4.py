...
def frame(original_image, color, frame_width):
    ...
    0 < frame width < 1 is the border as 
    ...
    drawing_layer.rectangle((0, 0, thickness, 2*width), fill=(r,g, b, 255)),
...
def frame_all_images(directory=None, color=(0,136,0),frame_width=(0.05)):
    ...
    new_directory = os.path.join(directory, 'Client_images')
    try:
    ...
    for n in range(len(image_list)):
        ...
        # Add watermark picture to new_image NEW CODE
...
#def add_logo(directory=None):      # OLD CODE USED IN FOR THE NEW CODE 
